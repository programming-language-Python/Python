...
class User(db.Model):
    ...
    # Sequence('user_id_seq') - сам автоматически генерирует id
    # primary_key=True - обязательный и уникальный ключ
    ...
    # для того чтобы предлагал методы при вводе User.query.
    query: sql.Select
