...
@admin.register(Order_numbers)
class Order_numbersAdmin(admin.ModelAdmin):
    list_display = ('id', 'user', 'data', 'count', 'price', 'date')
    list_display_links = ('id', 'data')
    readonly_fields = ('count', 'price', 'date')
    search_fields = ('id', 'user', 'data', 'price', 'date')
    save_on_top = True


@admin.register(Orders)
class OrdersAdmin(admin.ModelAdmin):
    list_display = ('id', 'user', 'key', 'data', 'count')
    list_display_links = ('id', 'user')
    readonly_fields = ('key', 'count')
    search_fields = ('id', 'user', 'key', 'data')
    save_on_top = True
