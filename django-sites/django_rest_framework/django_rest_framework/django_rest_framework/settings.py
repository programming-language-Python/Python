...
DATABASES = {
    'default': {
        ...
        'NAME': 'movie',
        'USER': 'postgres',
        'PASSWORD': 'predqoiualienqouo',
        'HOST': 'localhost',
        'PORT': '5400'  # смотреть порт для postgresql: C:\Program Files\Programs\PostgreSQL\13\data\postgresql.conf
    }
}
...
AUTHENTICATION_BACKENDS = (
    # VK OAuth2
    'social_core.backends.vk.VKOAuth2',  # провайдер
